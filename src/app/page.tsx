    ...
    return (
        <>
            ...
            <main id='main' className='relative flex grow flex-col'>
                ...
                {/* A gulf less a stack on top: the first cards' clouds
                 * billow upward ~50px, so a plain seam would let them
                 * bleed into the bio text above — this keeps ~24px of
                 * clearance even at the mobile end, while the seam
                 * below (twMerge) keeps the gap breathing with the
                 * viewport. */}
                <Section
                    id='research'
                    className='pt-[calc(var(--space-gulf)-var(--space-stack))]'
                >
                ...
                <footer className='pb-seam pt-gulf text-center'>
                    <div className='container mx-auto max-w-[64rem] px-inset'>
                        ...
                        <p
                            data-cloud='dead'
                            className='mx-auto w-fit font-script text-4xl leading-none text-foreground'
                        >
