    ...
    return (
        <div className='relative mx-auto w-full max-w-screen-lg px-6 pb-12 md:px-8'>
            <header className='flex items-center justify-between py-6'>
                ...
                <h1 className='accent-1 text-sm font-bold uppercase tracking-widest'>Projects</h1>
                <div className='w-16' />
            </header>
            <div className='flex flex-col gap-10'>
                <div className='space-y-3'>
                    <div className='sticky top-0 z-10 bg-background py-3'>
                        <h2 className='accent-2 text-sm font-bold uppercase tracking-widest'>CS185 — Deep RL</h2>
                ...
                <div className='space-y-3'>
                    <div className='sticky top-0 z-10 bg-background py-3'>
                        <h2 className='accent-3 text-sm font-bold uppercase tracking-widest'>CS280 — Computer Vision</h2>
                        <p className='text-xs text-foreground mt-1'>
                            with{' '}
                ...
                <div className='space-y-3'>
                    <div className='sticky top-0 z-10 bg-background py-3'>
                        <h2 className='accent-4 text-sm font-bold uppercase tracking-widest'>Academic</h2>
                    </div>
                ...
                <div className='space-y-3'>
                    <div className='sticky top-0 z-10 bg-background py-3'>
                        <h2 className='accent-5 text-sm font-bold uppercase tracking-widest'>Personal</h2>
                    </div>
