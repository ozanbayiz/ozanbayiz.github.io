...
Some SDFs isolate oddly specific semantic archetypes, entirely divorced from demographics:

<Figure src="/projects/vista/neckbeard_feature.jpg" alt="Discord screenshot of a labmate reacting to a newly discovered feature, showing its top-activating image strip" caption="Feature discovery in practice: a labmate's live reaction to the 'neckbeard' SDF and its top-activating images." />
...
<Figure src="/projects/vista/LP_training.png" alt="Linear probing pipeline" caption="Visual representation of the Linear Probing pipeline. Mean-pooled spatial features are fed into linear classifiers to predict demographics." />
