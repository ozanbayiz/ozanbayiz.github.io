...
<Figure src="/projects/vizdoom-dqn/training_curve.png" alt="Evaluation return over 500k training steps on DefendTheCenter with AIMv2-Large encoder, two seeds" caption="Evaluation return over training for the best configuration (AIMv2-Large, τ = 0.001) across two seeds." />
...
<Figure src="/projects/vizdoom-dqn/tau_ablation.png" alt="Evaluation return comparison between tau=0.005 and tau=0.001" caption="Target network update rate ablation. τ = 0.001 (blue) achieves higher peak performance and lower variance than τ = 0.005 (red)." />
