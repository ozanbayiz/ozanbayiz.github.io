...
I did not really want to manually label correspondences. After doing some research, I found dlib's `shape_predictor_68_face_landmarks.dat` which is a face landmark detector that labels 68 points on the face.

![face landmarks](/projects/cs180/proj3/face_landmarks.png)
...
![efros stoica triangulations](/projects/cs180/proj3/efros_stoica_triangulations.png)
...
![midface](/projects/cs180/proj3/efros_stoica_midface.png)
...
![morph sequence](/projects/cs180/proj3/morph_sequence.gif)
...
![caricature](/projects/cs180/proj3/caricature.png)
...
![ozan average turk](/projects/cs180/proj3/ozan_average_turk.png)
