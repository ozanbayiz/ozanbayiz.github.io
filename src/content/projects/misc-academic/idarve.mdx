...
Instead, we computed the mean across the patch dimension, yielding a single vector for each image:
...
<Figure src="/projects/idarve/neckbeard_feature.jpg" alt="A feature associated with sunglasses" caption="Figure 4. We found a feature associated with images of people wearing sunglasses."/>
