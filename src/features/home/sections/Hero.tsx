...
const SOCIAL_ICONS: Record<SocialIcon, ReactNode> = {
    github: (
        <svg aria-hidden="true" className="h-8 w-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    cv: (
        <svg aria-hidden="true" className="h-8 w-8 fill-current" viewBox="0 0 26 28" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd">
