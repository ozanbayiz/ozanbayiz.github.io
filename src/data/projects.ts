...
// Inline CS180 projects (mirroring previous cs180.ts) so all projects live here
projectsData.push(
    {
        collection: 'cs180',
        slug: 'cs180-proj1',
        title: 'Project 1: Colorizing the Prokudin-Gorskii Photo Collection',
        shortTitle: 'CS180 Project 1: Prokudin-Gorskii',
        description:
    ...
    },
    {
        ...
        shortTitle: 'CS180 Project 2: Filters & Frequencies',
        description:
    ...
    },
    {
        ...
        shortTitle: 'CS180 Project 3: Face Morphing',
        description:
    ...
    },
    {
        collection: 'cs180',
        slug: 'cs180-proj4',
        title: 'Project 4: [Auto]stitching Photo Mosaics',
        shortTitle: 'CS180 Project 4: Photo Mosaics',
        description:
    ...
    },
    {
        collection: 'cs180',
        slug: 'cs180-proj5a',
        title: 'Project 5A: The Power of Diffusion Models!',
        shortTitle: 'CS180 Project 5A: Diffusion Models',
        description:
            'Diffusion sampling loops, CFG, image-to-image, visual anagrams, and hybrid images.',
        imageUrl: '/projects/cs180/proj5/cover.jpeg',
        heroImageSrc: '/projects/cs180/proj5/cover.jpeg',
        gitUrl: 'https://github.com/ozanbayiz/cs180',
        date: '2024-11-07'
    },
    {
        collection: 'cs180',
        slug: 'cs180-proj5b',
        title: 'Project 5B: Diffusion Models from Scratch!',
        shortTitle: 'CS180 Project 5B: Diffusion from Scratch',
        description:
            'Training UNets: unconditional, time-conditioned, and class-conditioned; results and samples.',
        imageUrl: '/projects/cs180/proj5/5b/thumbnail.jpeg',
        heroImageSrc: '/projects/cs180/proj5/5b/thumbnail.jpeg',
        gitUrl: 'https://github.com/ozanbayiz/cs180',
        date: '2024-11-19'
    },
    {
        ...
        shortTitle: 'CS180 Project 6: NeRF',
        description:
